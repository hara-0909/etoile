...
<body class="reservation_index">
<div id="app">
    <div class="p-3">
        <div class="mb-4container">
            <div class="btn-group mb-4">
                ...
                <!-- この部分 -->
                <button type="button" class="btn btn-outline-secondary date-picker-btn" v-text="date"></button>

                <button type="button" class="btn btn-outline-secondary" @click="moveDate(1)">&gt;</button>
            </div>
        <div class="mb-5container">
            <div class="mb-5" v-for="room in rooms">
                <h4>
                    <span v-text="room.name">Info</span>
                </h4>
    ...
    <div class="new_reservation">
                <a href="{{ route('user.dashboard') }}">戻る</a><br>
            </div>
</div>
    ...
    Vue.createApp({
        ...
        mounted() {
            ...
            $('.date-picker-btn').datepicker({
                ...
                this.dt = luxon.DateTime.fromJSDate(e.date);
            });
